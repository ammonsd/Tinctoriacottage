...
<!--#INCLUDE FILE="../dir/dir_select.inc" -->
...
<%
   ...
   Call Logon_Check(GetCurPath("")&"new_dir_entry.asp",1,strLogonGrp)
...
SUB Display_Form
   ...
   strFldAlign = "R"
   call Get_Data("new_dir_entry.asp","New Directory Entry Details",30)
   Response.End
END SUB
